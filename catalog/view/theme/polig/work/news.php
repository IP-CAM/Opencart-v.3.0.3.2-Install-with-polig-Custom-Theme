  ...
  <div class="container">
      <div class="news_wrap">
      	<div class="news_block">
      		<div>
      			<h2 class="news_title">
      			Новое поступление PRABOS
      		</h2> 
      		<p class="news_paragraph ">
      			<span class="lay gradient"></span>
				...
				corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur?"
				<span class="mask">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur
				</span>
      		</p>
      		<button class="news_btn btn_basket">Подробнее</button>
      		</div>
      	...
      	<div class="news_block">
      		<div>
      			<h2 class="news_title">
      			СКИДКИ! До 10 апреля на всю пиротехнику
      		</h2> 
      		<p class="news_paragraph ">
      			<span class="lay gradient"></span>
      			Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur
