...
//			$this->model_catalog_information->editInformation($this->request->get['id_inf_cat'], $this->request->post);
//
//			$this->session->data['success'] = $this->language->get('text_success');
//
//			$url = '';
...
//		$information_total = $this->model_catalog_information->getTotalInformations();
//
//		$results = $this->model_catalog_information->getInformations_cats($filter_data);
//
//		foreach ($results as $result) {
//			$data['informations_cats'][] = array(
//				'id_inf_cat' => $result['id_inf_cat'],
//				'title'          => $result['title'],
//				'sort'     => $result['sort'],
//				'edit'           => $this->url->link('catalog/information/edit', 'user_token=' . $this->session->data['user_token'] . '&id_inf_cat=' . $result['id_inf_cat'] . $url, true)
//			);
//		}
//
//		if (isset($this->error['warning'])) {
...
//
//	protected function getForm() {
//		$data['text_form'] = !isset($this->request->get['id_inf_cat']) ? $this->language->get('text_add') : $this->language->get('text_edit');
//
//		if (isset($this->error['warning'])) {
//			$data['error_warning'] = $this->error['warning'];
//		} else {
...
//		);
//
//		if (!isset($this->request->get['id_inf_cat'])) {
//			$data['action'] = $this->url->link('catalog/information/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
//		} else {
//			$data['action'] = $this->url->link('catalog/information/edit', 'user_token=' . $this->session->data['user_token'] . '&id_inf_cat=' . $this->request->get['id_inf_cat'] . $url, true);
//		}
//
//		$data['cancel'] = $this->url->link('catalog/information', 'user_token=' . $this->session->data['user_token'] . $url, true);
//
//		if (isset($this->request->get['id_inf_cat']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
//			$information_info = $this->model_catalog_information->getInformation($this->request->get['id_inf_cat']);
//		}
//
//		$data['user_token'] = $this->session->data['user_token'];
//
...
//		} elseif (!empty($information_info)) {
//			$data['sort'] = $information_info['sort'];
//		} else {
//			$data['sort'] = '';
//		}
//
//		if (isset($this->request->post['information_seo_url'])) {
//			$data['information_seo_url'] = $this->request->post['information_seo_url'];
//		} elseif (isset($this->request->get['id_inf_cat'])) {
//			$data['information_seo_url'] = $this->model_catalog_information->getInformationSeoUrls($this->request->get['id_inf_cat']);
//		} else {
//			$data['information_seo_url'] = array();
//		}
//
...
////			$data['information_layout'] = $this->request->post['information_layout'];
////		} elseif (isset($this->request->get['information_id'])) {
////			$data['information_layout'] = $this->model_catalog_information->getInformationLayouts($this->request->get['id_inf_cat']);
////		} else {
////			$data['information_layout'] = array();
////		}
////
